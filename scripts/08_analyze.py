...
med = feat["duration_s"].median()
axes[0].hist(feat["duration_s"], bins=50, color="#2980b9")
axes[0].axvline(3 * med, color="#c0392b", ls="--", label=f"3x median ({3*med:.0f}s)")
axes[0].axvline(0.15 * med, color="#c0392b", ls=":", label=f"0.15x median ({0.15*med:.0f}s)")
axes[0].set_xlabel("episode duration (s)")
axes[0].set_ylabel("episodes")
axes[0].set_title("duration")
axes[0].legend(fontsize=8)
axes[1].hist(feat["motion_energy"], bins=50, color="#16a085")
axes[1].set_xlabel("mean hand speed (m/s)")
axes[1].set_title("motion energy")
